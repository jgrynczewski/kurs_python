...
# Jeżeli użytkownik wprowadzi wartość 'blank' będzie ona ignorowana. Jeżeli użytkownik
# wprowadzi 'exit' program zakończy swoje działanie. Przykładowe wywołanie:
